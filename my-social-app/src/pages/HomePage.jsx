  ...
  return (
    <div style={{ fontFamily: "sans-serif", background: "#f8f9fa", minHeight: "100vh" }}>
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
        <header style={{ width: "100%", maxWidth: 1200, background: "#fff", borderRadius: "12px", boxShadow: "0 2px 12px #e0e0e0", padding: "32px 32px 24px 32px", margin: "40px 0 0 0" }}>
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center", marginTop: 40 }}>
        <div style={{ width: "100%", maxWidth: 1200, background: "#fff", color: "#222", boxShadow: "0 2px 12px #e0e0e0", borderRadius: "12px", padding: "40px 24px" }}>
      ...
      <footer style={{ marginTop: "60px", color: "#b2bec3", fontSize: "0.95rem", textAlign: "center" }}>
